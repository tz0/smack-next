					...
					void **ctx, u32 *ctxlen)
{
	...
	pr_info("TZT: smack_dentry_init_security Initializing.\n");

	/**
	 * TODO
	 * compute inode smack pointer and context based on the process and
	 * the parent directory contexts.
	 */
	// struct inode_smack *isp;
...
static __init int smack_init(void)
{
	...
	pr_info("TZT: dev version of SMACK Initializing.\n");
